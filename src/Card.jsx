...
const DEFAULT_IMAGE = "https://static.vecteezy.com/system/resources/previews/004/639/366/non_2x/error-404-not-found-text-design-vector.jpg"
                            ...
                            <div className="fixed inset-0 grid place-items-center z-[100]">
                                ...
                                >
                                    <div className="relative overflow-hidden object-cover object-center">
                                        <Carousel
                                            slides={active.srcs.map((src) => src?.image_url ?? DEFAULT_IMAGE)}
                                        />
                                    </div>
            ...
            <div className="max-w-2xl mx-auto w-full items-start gap-4">
                ...
                >
                    <div className="flex gap-4 flex-col w-full">
                        ...
                        >
                            <ImageHover src={card.srcs[0]?.image_url ?? DEFAULT_IMAGE} alt={card.title} />
                        </motion.div>
